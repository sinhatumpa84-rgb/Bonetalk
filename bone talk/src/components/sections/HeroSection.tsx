    ...
    <div className="relative flex h-full w-full items-center justify-center bg-transparent">
      ...
      <div className="relative aspect-square w-full max-w-[420px] p-4">
        ...
        <svg viewBox="0 0 400 400" className="h-full w-full" aria-label="BoneTalk Neck Wearable Diagram">
          ...
          <circle cx="200" cy="200" r="170" fill="url(#neckGlow)" stroke="rgba(245,242,235,0.06)" strokeWidth="1" />
          <circle cx="200" cy="200" r="130" fill="none" stroke="rgba(34,211,238,0.15)" strokeDasharray="3 3" />
          ...
          <g transform="translate(145, 205)">
            <rect x="0" y="0" width="110" height="50" rx="8" fill="#181822" stroke="#22d3ee" strokeWidth="1.5" />
            <rect x="8" y="8" width="94" height="34" rx="4" fill="#0c0c12" />
            {/* Status Micro LED */}
            <circle cx="55" cy="25" r="10" fill="none" stroke="#22d3ee" strokeWidth="2" />
            <circle cx="55" cy="25" r="4" fill="#22d3ee" className="animate-pulse" />
            {/* Surface Gold Electrodes */}
            <circle cx="24" cy="25" r="6" fill="#eab308" />
            <circle cx="86" cy="25" r="6" fill="#eab308" />
          </g>
      ...
      <div className="relative mx-auto grid w-full max-w-[1400px] flex-1 grid-cols-1 items-center gap-8 px-6 pt-28 md:grid-cols-2 md:gap-12 md:px-10 md:pt-36">
        ...
        >
          ...
          <div
            ...
            style={{
              background: `radial-gradient(circle at 50% 45%, rgba(34,211,238,${0.08 + progress * 0.08}) 0%, transparent 68%)`,
            }}
          />
