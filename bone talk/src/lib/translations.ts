...
export const en: TranslationSchema = {
  ...
  signal: {
    ...
    footerNote: '⚡ Real-time neural inference powered by Arduino UNO R4 WiFi & TinyML engine.',
    cmdSub: {
  ...
  hardware: {
    ...
    description:
      'Clinical-grade analog front-end integrated with edge TinyML compute on the Arduino UNO R4 WiFi silicon platform.',
  ...
  footer: {
    ...
    experienceBtn: 'EXPERIENCE BoneTalk',
...
export const TRANSLATIONS: Record<string, TranslationSchema> = {
  ...
  hi: createTranslation({
    nav: { technology: 'तकनीक', howItWorks: 'यह कैसे काम करता है', ai: 'एआई', hardware: 'हार्डवेयर', worldwide: 'वैश्विक', vision: 'दृष्टिकोण', experience: 'BoneTalk का अनुभव करें' },
    hero: {
      eyebrow: 'गले में पहनी जाने वाली सहायक तंत्रिका तकनीक / 2026',
      line1: 'शरीर के पास',
      line2: 'एक आवाज़ है।',
      description: 'BoneTalk एक गले में पहना जाने वाला सहायक उपकरण है जो मांसपेशियों की गतिविधि को स्पष्ट और सार्थक बोली में परिवर्तित करता है।',
    ...
    teach: {
      ...
      titleLine2: 'सिखाएं।',
      description: 'प्रत्येक उपयोगकर्ता का एक विशिष्ट तंत्रिका-मांसपेशी हस्ताक्षर होता है। BoneTalk 60 सेकंड से भी कम समय में आपकी मांसपेशियों के इशारों को सीखता है।',
      activeVocab: 'सक्रिय प्रशिक्षित शब्दावली',
      clickToPlay: 'आवाज़ सुनने के लिए क्लिक करें',
      calibrationTitle: 'इशारा अंशांकन सूट',
      calibrationDesc: '3 मांसपेशी संकुचन परीक्षणों को रिकॉर्ड करके BoneTalk को एक कस्टम वाक्यांश सिखाएं।',
    ...
    pipeline: { eyebrow: 'यह कैसे काम करता है', title: 'मांसपेशियों के संकेत से आवाज़ तक', description: 'BoneTalk प्राकृतिक मांसपेशियों की गतिविधि को वास्तविक समय में बोली जाने वाली भाषा में बदलता है।' },
    worldwide: {
      eyebrow: 'वैश्विक पहुंच और प्रभाव',
      titleLine1: 'एक आवाज़ के लिए निर्मित।',
      titleLine2: 'पूरी दुनिया के लिए डिज़ाइन किया गया।',
      description: 'संचार की कोई सीमाएँ नहीं होतीं। BoneTalk लोगों को भाषाओं, क्षेत्रों और संस्कृतियों के पार संवाद करने में मदद करता है।',
      ...
      statementBody: 'स्थानीय संचार से लेकर वैश्विक संपर्क तक, BoneTalk को सहायक संचार को दुनिया भर में सुलभ बनाने के लिए बनाया गया है।',
    ...
    final: { r1Line1: 'जब आवाज़', r1Line2: 'शांत हो जाती है,', r2Line1: 'तब भी संचार', r2Line2: 'रुकना नहीं चाहिए।', subtitle: 'AI-संचालित सहायक संचार प्रणाली', coreActive: 'BoneTalk कोर सक्रिय', signalFidelity: '100% सिग्नल सटीकता' },
  }),
  bn: createTranslation({
    nav: { technology: 'প্রযুক্তি', howItWorks: 'কীভাবে কাজ করে', ai: 'এআই', hardware: 'হার্ডওয়্যার', worldwide: 'বিশ্বব্যাপী', vision: 'ভিশন', experience: 'BoneTalk-এর অভিজ্ঞতা নিন' },
    hero: {
      eyebrow: 'গলায় পরার সহায়ক নিউরোটেকনোলজি / ২০২৬',
      line1: 'দেহেরও',
      line2: 'একটি স্বর আছে।',
      description: 'BoneTalk একটি গলায় পরা পরিধানযোগ্য ডিভাইস যা পেশীর কার্যকলাপকে স্পষ্ট বাক্যে রূপান্তরিত করে।',
    ...
    teach: {
      ...
      description: 'প্রতিটি ব্যবহারকারীর একটি অনন্য পেশী সংকেত রয়েছে। BoneTalk ৬০ সেকেন্ডেও কম সময়ে আপনার পেশীর সংকেত ক্যালিব্রেট করে সেটিকে স্পষ্ট বাচনে পরিণত করে।',
      ...
      calibrationDesc: '৩টি সংকোচন পরীক্ষা রেকর্ড করে BoneTalk-কে আপনার নিজস্ব বাক্য শেখান।',
    ...
    pipeline: { eyebrow: 'কীভাবে কাজ করে', title: 'পেশীর সিগন্যাল থেকে কণ্ঠস্বরে', description: 'BoneTalk রিয়েল-টাইমে পেশীর স্বাভাবিক সংকেতকে বাচনে রূপান্তর করে।' },
    worldwide: {
      eyebrow: 'বিশ্বব্যাপী সুযোগ ও প্রভাব',
      titleLine1: 'একটি স্বরের জন্য নির্মিত।',
      titleLine2: 'সমগ্র বিশ্বের জন্য ডিজাইন করা।',
      description: 'যোগাযোগের কোনো সীমানা নেই। BoneTalk ভাষা, অঞ্চল ও সংস্কৃতির সীমা ছাড়িয়ে মানুষকে ভাব প্রকাশে সাহায্য করে।',
      ...
      statementBody: 'স্থানীয় যোগাযোগ থেকে বৈশ্বিক সংযোগ পর্যন্ত, BoneTalk সহায়ক যোগাযোগকে বিশ্বব্যাপী সহজলভ্য করার জন্য নির্মিত।',
    ...
    final: { r1Line1: 'কণ্ঠস্বর যখন', r1Line2: 'নীরব হয়ে যায়,', r2Line1: 'যোগাযোগ তখনও', r2Line2: 'থেমে থাকে না।', subtitle: 'AI-চালিত সহায়ক যোগাযোগ ব্যবস্থা', coreActive: 'BoneTalk কোর সক্রিয়', signalFidelity: '১০০% সিগন্যাল সঠিকতা' },
  }),
}
